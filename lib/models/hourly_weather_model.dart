...
String hourlyWeatherModelToJson(HourlyWeatherModel data) => json.encode(data.toJson());
...
class Sys {
  ...
  factory Sys.fromJson(Map<String, dynamic> json) => Sys(pod: podValues.map[json["pod"]]!);
...
class Wind {
  ...
  factory Wind.fromJson(Map<String, dynamic> json) =>
      Wind(speed: json["speed"]?.toDouble(), deg: json["deg"], gust: json["gust"]?.toDouble());
